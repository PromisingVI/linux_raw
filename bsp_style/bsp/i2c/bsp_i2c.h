...
#define I2C_INFO(format, ...)	printf("i2c info(%s, %d): "format"\r\n", __func__, __LINE__, ##__VA_ARGS__)
#define I2C_DBG(format, ...)	printf("i2c warning(%s, %d): "format"\r\n", __func__, __LINE__, ##__VA_ARGS__)
#define I2C_ERR(format, ...)	printf("i2c error(%s, %d): "format"\r\n", __func__, __LINE__, ##__VA_ARGS__)
