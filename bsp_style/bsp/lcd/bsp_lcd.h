...
#define LCD_INFO(format, ...)	printf("LCD info(%s, %d): "format"\r\n", __func__, __LINE__, ##__VA_ARGS__)
#define LCD_DBG(format, ...)	printf("LCD warning(%s, %d): "format"\r\n", __func__, __LINE__, ##__VA_ARGS__)
#define LCD_ERR(format, ...)	printf("LCD error(%s, %d): "format"\r\n", __func__, __LINE__, ##__VA_ARGS__)
...
struct tftlcd_typedef{
	...
	unsigned char pixsize;				/* LCD 每个像素所占字节大小 */
